...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { cafeteria_id: @dish.cafeteria_id, name: @dish.name } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { cafeteria_id: @dish.cafeteria_id, name: @dish.name } }
